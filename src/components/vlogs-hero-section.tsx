...
interface VlogsHeroSectionProps {
  className?: string;
}
...
const VLOG_POSTS = [
  {
    id: 1,
    title: 'A Week in Tokyo: City Life',
    category: 'Travel',
    location: 'Tokyo',
    date: 'August 20, 2025',
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/3585089/pexels-photo-3585089.jpeg?auto=compress&cs=tinysrgb&w=1600',
  },
  {
    id: 3,
    ...
    location: 'Bali',
    date: 'July 15, 2025',
    image: 'https://images.pexels.com/photos/1583582/pexels-photo-1583582.jpeg?auto=compress&cs=tinysrgb&w=1600',
  },
  {
    id: 4,
    title: 'City Lights & Night Walks',
    category: 'Lifestyle',
    location: 'New York',
    date: 'June 28, 2025',
    image: 'https://images.pexels.com/photos/1486222/pexels-photo-1486222.jpeg?auto=compress&cs=tinysrgb&w=1600',
  },
];

export const VlogsHeroSection: React.FC<VlogsHeroSectionProps> = ({ className }) => {
  ...
  return (
    <section
      ...
      style={{ height: `${100 + (VLOG_POSTS.length - 1) * 80}vh` }}
    >
        ...
        <div className="relative h-full w-full flex items-center justify-center px-6 sm:px-8 md:px-12 lg:px-16 pt-20">
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 max-w-[1400px] w-full">
            ...
            <div className="relative flex flex-col justify-center">
              ...
              >
                This is where I share my vlogs — capturing moments from my travels, creative projects, and daily adventures.
                Each video is a window into the experiences that shape my journey.
              </motion.p>
            </div>

            {/* Right: Elegant Fade Carousel */}
            <div className="relative h-[80vh] flex items-center justify-center">
              {VLOG_POSTS.map((post, index) => {
...
export default VlogsHeroSection;
